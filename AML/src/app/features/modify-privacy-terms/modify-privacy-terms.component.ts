...
@Component({
  selector: 'app-modify-privacy-terms',
  templateUrl: './modify-privacy-terms.component.html',
  styleUrls: ['./modify-privacy-terms.component.css']
})
export class ModifyPrivacyTermsComponent implements OnInit,AfterViewInit {
