...
@Component({
  selector: 'app-ko-fiususpicious-transaction',
  templateUrl: './ko-fiususpicious-transaction.component.html',
  styleUrls: ['./ko-fiususpicious-transaction.component.css']
})
export class KoFIUSuspiciousTransactionComponent implements OnInit,AfterViewInit {
