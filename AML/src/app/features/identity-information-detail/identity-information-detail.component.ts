...
@Component({
  selector: 'app-identity-information-detail',
  templateUrl: './identity-information-detail.component.html',
  styleUrls: ['./identity-information-detail.component.css']
})
export class IdentityInformationDetailComponent implements OnInit,AfterViewInit {
  ...
  complete() {
    ...
    this.router.navigate(['/layout/eddProgressApplicationComponent']);
