...
@Component({
  selector: 'app-company-internal-residual-risk-entry',
  templateUrl: './company-internal-residual-risk-entry.component.html',
  styleUrls: ['./company-internal-residual-risk-entry.component.css']
})
export class CompanyInternalResidualRiskEntryComponent implements OnInit,AfterViewInit {
