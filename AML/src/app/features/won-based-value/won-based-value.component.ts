...
@Component({
  selector: 'app-won-based-value',
  templateUrl: './won-based-value.component.html',
  styleUrls: ['./won-based-value.component.css']
})
export class WonBasedValueComponent implements OnInit, AfterViewInit {
