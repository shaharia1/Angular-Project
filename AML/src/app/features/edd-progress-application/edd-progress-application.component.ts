...
@Component({
  selector: 'app-edd-progress-application',
  templateUrl: './edd-progress-application.component.html',
  styleUrls: ['./edd-progress-application.component.css']
})
export class EddProgressApplicationComponent implements  OnInit,AfterViewInit {
